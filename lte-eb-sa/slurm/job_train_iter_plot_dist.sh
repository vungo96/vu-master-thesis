...
python train_iter.py --config configs/train-div2k/train_edsr-baseline-lte-variable-input-div2k-plot-distribution.yaml --gpu 0 --tag plot_scale_distribution-enlarged